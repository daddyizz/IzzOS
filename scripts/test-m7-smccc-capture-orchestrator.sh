...
static const M7_SMCCC_TRANSCRIPT_BINDING mBinding = {
  ...
  .CaptureProvisionBindingSha256 = "9999999999999999999999999999999999999999999999999999999999999999"
};
...
main (void)
{
  ...
  assert(strstr(mOutputBuffer, "capture-provision-binding-sha256: 9999999999999999999999999999999999999999999999999999999999999999\n") != NULL);
