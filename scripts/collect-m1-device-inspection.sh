...
case "${CLASSIFICATION:-}" in
  TARGET_MISMATCH_BLOCKED|FASTBOOTD_DETECTED_BLOCKED|LOCKED_BOOTLOADER_BLOCKED|BOOTLOADER_STATE_UNKNOWN_BLOCKED|INSUFFICIENT_DATA|NEED_EXACT_FASTBOOT_INSPECTION|ADB_AUTHORIZATION_REQUIRED|DEVICE_CONNECTION_REQUIRED|DEVICE_TOOLCHAIN_REQUIRED|DEVICE_SELECTION_AMBIGUOUS_BLOCKED)
    echo
