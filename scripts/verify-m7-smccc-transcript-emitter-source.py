...
checks = [
    ...
    ("emitter-binds-nine-exact-sha256-values", header.count("Sha256;") == 9 and source.count("IsExactSha256 (Binding->") == 9),
    ...
    ("emitter-binds-canonical-capture-provision", '"capture-provision-binding-sha256"' in source),
