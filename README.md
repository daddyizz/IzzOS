...
**Internal engineering checkpoint:** M11 content-bound temporary-route evidence gate implemented; product M1 awaits exact local stock-image acceptance and genuine exact-device route-validation artifacts<br>
